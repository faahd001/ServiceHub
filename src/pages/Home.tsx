        ...
        <div className="text-center max-w-3xl mx-auto space-y-8">
          ...
          >
            ...
            <p className="mt-6 text-xl text-gray-600">
              Connect with top-rated engineers, mechanics, and plumbers in your area. 
          ...
          <motion.form
            ...
            className="flex flex-col md:flex-row gap-4 p-2 bg-white rounded-2xl shadow-xl border border-gray-100"
          >
      ...
      <section>
        <div className="flex items-end justify-between mb-10">
          <div>
            ...
            <p className="text-gray-500 mt-2">Find the right expert for your specific needs</p>
          </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6">
          {CATEGORIES.map((cat, i) => (
            <motion.button
              ...
              className="p-6 bg-white rounded-2xl border border-gray-100 hover:border-blue-200 hover:shadow-lg hover:-translate-y-1 transition-all text-center group"
            >
              <span className="text-4xl mb-4 block group-hover:scale-110 transition-transform">{cat.icon}</span>
              <h3 className="font-semibold text-gray-900">{cat.name}</h3>
              <p className="text-xs text-gray-400 mt-1">{cat.count} experts</p>
            </motion.button>
          ))}
        </div>
      </section>
